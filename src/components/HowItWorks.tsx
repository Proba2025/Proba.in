...
const steps = [
  {
    ...
    description:
      "Start with customized mock tests and coding challenges tailored to your target role or company.",
  },
  {
    icon: <Brain className="text-accent" size={24} />,
    title: "Receive Real-Time Feedback",
    description:
      "Get instant, personalized insights on your performance with detailed analysis of your responses.",
  },
  {
    icon: <FileCheck className="text-emerald-500" size={24} />,
    title: "Follow Your Learning Path",
    description:
      "Access an adaptive curriculum that evolves based on your strengths and areas that need improvement.",
  },
  {
    icon: <Award className="text-amber-500" size={24} />,
    title: "Track Your Progress",
    description:
      "Monitor your growth with comprehensive analytics that showcase your improvement over time.",
  },
  {
    icon: <Users className="text-purple-500" size={24} />,
    title: "Land Your Dream Role",
    description:
      "Enter interviews with confidence, fully prepared to showcase your skills and stand out from the competition.",
  },
];
    ...
    >
      ...
      <div className="container mx-auto px-6 md:px-12 relative">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          >
            From preparation to placement, Proba guides you through every step
            of your career advancement process.
          </motion.p>
        </div>

        {/* Steps */}
        <div className="relative">
          {/* Vertical Connecting Line (for large screens) */}
          ...
          {steps.map((step, index) => (
            ...
            >
              ...
              {/* Spacer for Layout Alignment (for large screens) */}
              <div
                className={`flex-1 ${
                  index % 2 !== 0 ? "md:justify-end" : "md:order-2"
                } hidden md:block`}
